const petArray = [
    {
        ...
        name: "George",
        color: "Green/Brown",
        skill: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
        type: "Dinosaur",
    },
    {
...
const showCats = () => {
    ...
    for (let i = 0; i < petArray.length; i++) {
        if (petArray[i].type.toLowerCase() === "cat") {
            output += `
            <div class="pet-card">
                <h2 class="card-header">${petArray[i].name}</h2>
                ...
                <footer class="card-footer ${petArray[i].type.toLowerCase()}">
...
const showDogs = () => {
    let output = "";
    for (let i = 0; i < petArray.length; i++) {
        if (petArray[i].type.toLowerCase() === "dog") {
            output += `
            <div class="pet-card">
                <h2 class="card-header">${petArray[i].name}</h2>
                <img src="${petArray[i].image}" alt="${petArray[i].name}">
...
const showDinos = () => {
    let output = "";
    for (let i = 0; i < petArray.length; i++) {
        if (petArray[i].type.toLowerCase() === "dinosaur") {
            output += `
            <div class="pet-card">
                <h2 class="card-header">${petArray[i].name}</h2>
                <img src="${petArray[i].image}" alt="${petArray[i].name}">
...
document.getElementById("dinos").addEventListener("click", showDinos);
...
const blankSubmit = document.getElementById("blank");
